...
1. 若切歌后 Lyricify 中的歌曲信息仍是上一首。
   1. 如果您是 Spotify Premium 用户，且是上一曲放完自动切到下一首，或是您手动点击下一首按钮进行切歌的，且是在运行 Lyricify 的设备上使用 Spotify 播放的
      ...
      3. 如果未连接，则需先修复 [Media Session 连接问题](/lyricify-4/faq/media-session-not-connected/)。
...
2. 若切歌后 Lyricify 中的歌曲信息已经更新，但歌词空白的时间较长，请完成 [`歌词标记`](/lyricify-4/basic/)，这样可以提高歌词获取效率。
