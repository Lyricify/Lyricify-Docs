...
### 主要区别
1. 发布新版本时，Microsoft Store 版本通常会提前 1-3 天更新，你可以提前体验新功能。
...
Self-contained 版本包含 `.NET 8.0 Desktop Runtime` 运行时，仅建议那些因某些原因无法正常安装 `.NET 8.0 Desktop Runtime` 的用户使用。其他用户建议选择 Microsoft Store 版本或标准安装版（即不包含 .NET 运行时的版本）。  
