...
## Lyricify Lite 有哪些功能
Lyricify Lite 目前有灵动词岛、桌面歌词、任务栏歌词功能，还从 Lyricify 4 移植了部分全屏歌词界面，支持所有接入了 SMTC 的音乐播放器，支持单独调节设备延迟、app 延迟、歌词显示等设置。

## 运行 Lyricify Lite
如果你想使用 Lyricify Lite，请确保你的系统版本不低于 10.0.17763.0，且安装了 `.NET Desktop Runtime 8.0`。如果启动时提示你的未安装，则需要你在这里下载安装：  
