...
目前 Lyricify Mobile 并未上架 App Store，原因详见[这里](/lyricify-mobile/troubleshooting/#ios-版是否会上架-app-store)。  
您可以在下载 `.ipa` 安装包后，采用自签的方式安装，点击[这里](/lyricify-mobile/ios-ipa-guide/)查看详细教程。   
...
特别的，在 Mac 设备上完成登录需参考[本教程](/lyricify-mobile/troubleshooting/#在-mac-设备上完成登录)。
...
不支持网页登录，需要手动输入 Token。类似的，可参考[本教程](/lyricify-mobile/troubleshooting/#在-mac-设备上完成登录)。
